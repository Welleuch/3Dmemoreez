...
export default function Checkout({ selectedConcept, onBack }) {
    return (
                    ...
                    <div className="glass p-10 md:p-14 rounded-[3rem] md:rounded-[4rem] border border-white/5 relative overflow-hidden group">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-white/40 text-sm md:text-lg font-light leading-relaxed mb-8">
                                    3D Printed in <span className="text-white/60 font-bold italic">Premium Matte Gray PLA</span>. Optimized for Prusa FDM technology with a solid structural base.
                                </p>
                        ...
                        <div className="glass p-10 md:p-12 rounded-[3rem] border border-white/10 relative overflow-hidden">
                            ...
                            <div className="space-y-6 mb-12">
                                <div className="flex justify-between text-white/40 font-light text-lg">
                                    ...
                                    <span className="text-white/80 font-black tracking-tighter">$45.00</span>
                                </div>
                                <div className="flex justify-between text-white/40 font-light text-lg">
                                ...
                                <div className="pt-6 border-t border-white/5 flex justify-between items-end">
                                    ...
                                    <span className="text-5xl md:text-6xl font-black tracking-tighter italic text-white leading-none">$45.00</span>
                                </div>
                            </div>
