...
from hy3dgen.shapegen.models.autoencoders import Latent2MeshOutput
...
def bpt_remesh(self, mesh: trimesh.Trimesh, verbose: bool = False, with_normal: bool = True, temperature: float = 0.5, batch_size: int = 1, pc_num: int = 4096, seed: int = 1234, samples: int = 50000):
        from hy3dgen.shapegen.bpt.model import data_utils
        ...
        from hy3dgen.shapegen.bpt.utils import sample_pc, joint_filter
